...
// When the window has finished loading create our google map below
    ...
    function init() {
        ...
        var address = "25, Jalan Puteri 4/6, Bandar Puteri, 47100 Puchong, Selangor, Malaysia"; //input box value
        geocoder.geocode( { 'address': address}, function(results, status) {
            ...
            }); //original code this is the code, this is original why got result[0].geometry.location
            }
        });
