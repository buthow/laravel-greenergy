...
<head>
    ...
    <title>Greenergy | Brand List</title>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <a href="/admin/brand/add" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Add Brand</a>
                                        ...
                                        <div class="col-sm-12">
                                            @if(!empty($brand_list))
                                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                    @foreach($brand_list as  $cl)
                                                        <tr>
                                                            <td>{{ $cl['brand_id'] }}</td>
                                                            <td>{{ $cl['brand_name'] }}</td>
                                                            <td>
                                                                <a href="/admin/brand/edit/{{ $cl['brand_id'] }}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                                                <a onclick="return confirm('Are you sure you want to delete this?')" href="/admin/brand/delete/{{ $cl['brand_id'] }}" type="button" class="btn btn-danger"><i class="fa fa-times"></i> Delete</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
