...
<head>
    ...
    <title>Greenergy | Case Study List</title>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <a href="/admin/case/add" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Add Case Study</a>
                                                ...
                                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    @foreach($case_list as  $cl)
                                                        <tr>
                                                            ...
                                                            <td>{{ $cl['case_name'] }}</td>
                                                            <td>
                                                                <a href="/admin/case/edit/{{ $cl['case_id'] }}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                                                <a onclick="return confirm('Are you sure you want to delete this?')" href="/admin/case/delete/{{ $cl['case_id'] }}" type="button" class="btn btn-danger"><i class="fa fa-times"></i> Delete</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
