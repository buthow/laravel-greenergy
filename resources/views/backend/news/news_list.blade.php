...
<head>
    ...
    <title>Greenergy | News List</title>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <a href="/admin/news/add" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Add News</a>
                                                ...
                                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    @foreach($news_list as  $nl)
                                                        <tr>
                                                            <td>{{ $nl['news_id'] }}</td>
                                                            <td>{{ $nl['news_name'] }}</td>
                                                            <td> {{ date('F d, Y', strtotime($nl['updated_at'])) }}</td>

                                                                <td>
                                                                    <a href="/admin/news/edit/{{ $nl['news_id'] }}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                                                    <a onclick="return confirm('Are you sure you want to delete this item?')" href="/admin/news/delete/{{ $nl['news_id'] }}" type="button" class="btn btn-danger"><i class="fa fa-times"></i> Delete</a>
                                                                </td>
