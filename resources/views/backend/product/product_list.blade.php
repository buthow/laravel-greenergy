            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <a href="/admin/product/add" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Add Product</a>
                                        ...
                                        <div class="col-sm-12">
                                            @if(!empty($product_list))
                                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                    @foreach($product_list as  $cl)
                                                        <tr>
                                                            <td>{{ $cl['product_name'] }}</td>
                                                            <td>{{ $cl['brand_name'] }}</td>
                                                            <td>{{ $cl['product_model'] }}</td>
                                                            <td>
                                                                <a href="/admin/product/edit/{{ $cl['product_id'] }}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                                                <a onclick="return confirm('Are you sure you want to delete this?')" href="/admin/product/delete/{{ $cl['product_id'] }}" type="button" class="btn btn-danger"><i class="fa fa-times"></i> Delete</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
